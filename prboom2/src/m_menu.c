...
setup_menu_t gen_settings3[] = { // General Settings screen2
  ...
  {"Restart Demo On Respawn",     S_YESNO, m_null, G_X, G_Y+ 7*8, {"demo_restartonrespawn"}},

  {"Movements",                   S_SKIP|S_TITLE,m_null,G_X, G_Y+9*8},
  {"Permanent Strafe50",          S_YESNO, m_null, G_X, G_Y+ 10*8, {"movement_strafe50"}, 0, 0, M_ChangeSpeed},
  ...
  {"No Vertical Mouse",           S_YESNO, m_null, G_X, G_Y+16*8, {"movement_mousenovert"}},
  {"Invert Mouse",                S_YESNO, m_null, G_X, G_Y+17*8, {"movement_mouseinvert"}, 0, 0, M_ChangeMouseInvert},
  {"Max View Pitch",              S_NUM,   m_null, G_X, G_Y+18*8, {"movement_maxviewpitch"}, 0, 0, M_ChangeMaxViewPitch},
  {"Mouse Strafe Divisor",        S_NUM,   m_null, G_X, G_Y+19*8, {"movement_mousestrafedivisor"}},
