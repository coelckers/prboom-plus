...
default_t defaults[] =
{
    ...
    {"snd_mididev", {NULL, &snd_mididev}, {0, ""}, UL, UL, def_str, ss_none}, // midi device to use for portmidiplayer and alsaplayer
    {
        ...
        def_bool, ss_none
    }, // low-pass filter borrowed from Chocolate Doom so upscaling old audio doesn't sound too horrible
    ...
    }, // mouse button number to use for backward motion
    {
        ...
        def_int, ss_keys
    }, // mouse button number to use for turning right
    {
        "mouseb_turnleft", {&mousebturnleft}, {-1}, -1, MAX_MOUSEB,
        def_int, ss_keys
    }, // mouse button number to use for turning left
    {
...

    {
        ...
        def_int, ss_keys
    }, // mouse button to switch to weapon 1 (fist/chainsaw)
    {
        "mb_weapon2", {&mb_weapon2}, {-1}, -1, MAX_MOUSEB,
        def_int, ss_keys
    }, // mouse button to switch to weapon 2 (pistol)
    {
        "mb_weapon3", {&mb_weapon3}, {-1}, -1, MAX_MOUSEB,
        def_int, ss_keys
    }, // mouse button to switch to weapon 3 (supershotgun/shotgun)
    {
        "mb_weapon4", {&mb_weapon4}, {-1}, -1, MAX_MOUSEB,
        def_int, ss_keys
    }, // mouse button to switch to weapon 4 (chaingun)
    {
        "mb_weapon5", {&mb_weapon5}, {-1}, -1, MAX_MOUSEB,
        def_int, ss_keys
    }, // mouse button to switch to weapon 5 (rocket launcher)
    {
        "mb_weapon6", {&mb_weapon6}, {-1}, -1, MAX_MOUSEB,
        def_int, ss_keys
    }, // mouse button to switch to weapon 6 (plasma rifle)
    {
        "mb_weapon7", {&mb_weapon7}, {-1}, -1, MAX_MOUSEB,
        def_int, ss_keys
    }, // mouse button to switch to weapon 7 (bfg9000)
    {
        "mb_weapon8", {&mb_weapon8}, {-1}, -1, MAX_MOUSEB,
        def_int, ss_keys
    }, // mouse button to switch to weapon 8 (chainsaw)
    {
        "mb_weapon9", {&mb_weapon9}, {-1}, -1, MAX_MOUSEB,
        def_int, ss_keys
    }, // mouse button to switch to weapon 9 (supershotgun)
